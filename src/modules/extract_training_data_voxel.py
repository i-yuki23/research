...
def extract_training_data_voxel(pdb_name, water_coordinate, gr_or_gist, grid_dims, data_voxel_num):
    water_voxel_index = coordinate_to_voxel_index(water_coordinate, pdb_name)
    # 各次元におけるスライス範囲を計算
    slices = []
    for i in range(3):
