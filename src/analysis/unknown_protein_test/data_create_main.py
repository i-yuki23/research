...
def main():
    ...
    ligand_voxel_num = 8
    data_voxel_num = 10
    base_voxel_path = get_test_gr_path(apo_name)

    ligand_pocket_definer = LigandPocketDefiner(apo_name=apo_name, holo_name=holo_name, voxel_num=ligand_voxel_num)
    ligand_pocket_water_molecules_extractor = LigandPocketWaterMoleculesExtractor(apo_name=apo_name)
    voxel_data_extractor = VoxelDataExtractor(apo_name=apo_name, holo_name=holo_name, base_voxel_path=base_voxel_path, data_voxel_num=data_voxel_num)
