...
def get_water_nums_by_pdb_list(pdb_names: list) -> list:
    water_nums = []
    for pdb_name in pdb_names:
        water_nums.append(get_water_num_by_pdb(pdb_name))

def get_displaceable_water_nums_by_pdb_list(pdb_names: list) -> list:
    water_nums = []
    for pdb_name in pdb_names:
        water_nums.append(get_displaceable_water_num_by_pdb(pdb_name))
    return water_nums

def get_non_displaceable_water_nums_by_pdb_list(pdb_names: list) -> list:
    water_nums = []
    for pdb_name in pdb_names:
        water_nums.append(get_non_displaceable_water_num_by_pdb(pdb_name))
    return water_nums
