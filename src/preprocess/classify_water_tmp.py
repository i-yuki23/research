...
def main():
    ...
    for pdb_name in pdb_names:
        ...
        paths = {
                "output_displaceable": os.path.join(f"/home/ito/research/data/{PATH_TYPE}/labeled_water/displaceable/", pdb_name,  f"pred_O_placed_{pdb_name}_3.0_surface_grid.pdb"),
                "output_non_displaceable": os.path.join(f"/home/ito/research/data/{PATH_TYPE}/labeled_water/non_displaceable/", pdb_name,  f"pred_O_placed_{pdb_name}_3.0_surface_grid.pdb"),
            }
        ...
        if LIGAND_POCKET_TYPE == "original":
            ...
            ligand_pocket_path = f"/home/ito/research/data/ghecom/ligand_pocket/{pdb_name}/ligand_pocket_from_grid.npy"
        try:
